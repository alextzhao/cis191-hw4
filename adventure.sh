...
# room (need to get out. (north) --> cannot go north, south, east, west.)
# Corridor (intersection)
# Engine room.
# periscope room
# virtual time machine room
# Armory
  ...
  case $1 in
    ...
    [Ee]ast )
        case $currLocation in
          ...
          initialLocationMessage codeRoom; currLocation=codeRoom;
            ;;
          periscopeRoom ) echo "you canot go east from here"
            ;;
          ## TODO: FIX THE LOGIC O THIS.
          timeMachineRoom )
    ...
    [Ww]est )
      case $currLocation in
        ...
        # TODO: Should I add another location for "outsideTimeMachine" room?
...
function lookaround {
  case $currLocation in
    ...
    top of it. You glance forward and suddnely realize that somehow you've been
    ...
    picture, of a beauful lady and a cute little girl... but who are they?"
      ;;
    ...
    with the US cities Los Angeles, New York and Chicago circled. You see a KeyCard
    laying in the table, and wonder what it is used for."
      ;;
    * ) echo "error: currentLocation $currLocation is not valid"
      ;;
  esac
...
function inspectItem {
  ...
  case $1 in
    ...
    division.' There also seems to be an object in the pocket..."
      ;;
    ...
    ;;
    * ) echo "unable to inspect $1: does not exist"
      ;;
  esac
...
function useItem {
  ...
  then
    echo "you do not have item \'$1\' in your inventory"; return;
  fi
